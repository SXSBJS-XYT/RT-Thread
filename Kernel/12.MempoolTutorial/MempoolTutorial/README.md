...
cd .\Kernel\12.MempoolTutorial\MempoolTutorial\
```

### 2. 打开工程
kprintf
- **Keil：** 打开 `Kernel/12.MempoolTutorial/MempoolTutorial/MDK-ARM/MempoolTutorial.uvprojx`
