...
基于STM32F429 + RT-Thread的小内存管理算法模板
...
cd .\Kernel\11.SmallmemTutorial\SmallmemTutorial\
```

### 2. 打开工程
kprintf
- **Keil：** 打开 `Kernel/11.SmallmemTutorial/SmallmemTutorial/MDK-ARM/SmallmemTutorial.uvprojx`
